...
export const NPCS: NpcDef[] = [
  ...
  },
  {
    ...
    age: 38,
    bio: 'Misturador de drinks e de verdades inconvenientes. Largou a filosofia quando percebeu que ninguém paga conta com sabedoria.',
    personality: 'Cínico · Filosófico · Sarcasticamente honesto',
    interests: ['🍹 Drinks', '📚 Bukowski', '🚬 Niilismo', '🌊 Mar', '💀 Existência'],
    story: 'Israel leu Bukowski aos 17 e nunca mais se recuperou. Tentou ser escritor, depois músico, depois cozinheiro. Virou bartender porque é o único trabalho onde as pessoas te pagam pra ouvir seus problemas e você ainda cobra pelo drink. Cada noite atrás do balcão é, segundo ele, material pra um livro que nunca vai escrever.',
    bodyColor: '#1a1a1a',
    headColor: '#c49060',
    hairColor: '#0a0808',
    pantsColor: '#111118',
